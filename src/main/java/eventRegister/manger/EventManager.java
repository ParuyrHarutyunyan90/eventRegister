package eventRegister.manger;

import eventRegister.dB.DBConnectionProvider;
...
public class EventManager {
    ...
    public void addEvent(Event event) throws SQLException {
        PreparedStatement preparedStatement = connection.prepareStatement("Insert into event(name, place," +
                "isOnline, price, event_type)" +
